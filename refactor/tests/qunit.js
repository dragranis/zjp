    ...
    */
    ...
    Test.prototype = {
        ...
        valid: function valid() {
            ...
            return regexFilter ?
                this.regexFilter(!!regexFilter[1],
                    regexFilter[2],
                    regexFilter[3],
                    fullName
                ) :
            ...
            if ("hidepassed" === field.name && "replaceState" in window$1.history) {
                ...
                if (tests) {
                    ...
                    if (field.checked) {
                        ...
                        try {
                            for (
                                var _iterator = hiddenTests[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true
                            ) {
        ...
        window$1.onerror = function(
            ...
            if (originalWindowOnError) {
                ...
                ret = originalWindowOnError.call.apply(
                    originalWindowOnError, [this, message, fileName, lineNumber, columnNumber, errorObj].concat(
                        args
                    )
                );
            }
